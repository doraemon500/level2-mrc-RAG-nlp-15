...
##-------------------------------------------------## below is the code from feature/aug_template.py ##-------------------------------------------------##
...
#             sys.argv.append(str(args['hyperparameters']['max_seq_length']))
#             sys.argv.append('--per_device_train_batch_size')
#             sys.argv.append(str(args['hyperparameters']['batch_train_size']))
#             sys.argv.append('--learning_rate')
#             sys.argv.append(args['hyperparameters']['learning_rate'])
#             sys.argv.append('--num_train_epochs')
#             sys.argv.append(str(args['hyperparameters']['num_train_epochs']))
