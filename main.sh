...
# Set up directories
train_dir="/data/ephemeral/home/level2-mrc-nlp-15/models/train_20241018_014457"
...
# python main.py --output_dir $eval_dir --alpha_retrieval 0.3  --do_eval
# python main.py --output_dir $eval_dir --model_name_or_path $train_dir --alpha_retrieval 0.9 --do_eval
